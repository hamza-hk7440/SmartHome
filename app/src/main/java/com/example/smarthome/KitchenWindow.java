...
public class KitchenWindow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kitchen_window);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (isOpen != null) {
                    ...
                    windowSwitch.setOnCheckedChangeListener((button, checked) -> {
                        ...
                        Toast.makeText(KitchenWindow.this,
    ...
    private void checkCode(String input) {
        ...
        findViewById(R.id.button7).setOnClickListener(v -> {
            startActivity(new Intent(KitchenWindow.this, Kitchen.class));
            finish();
        });
    }
}