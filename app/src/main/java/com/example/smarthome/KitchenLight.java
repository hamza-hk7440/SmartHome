...
public class KitchenLight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightRef= FirebaseDatabase.getInstance().getReference("users").child(uid).child("kitchenStatus").child("light");
        ...
        goBack.setOnClickListener(v -> {
            startActivity(new Intent(KitchenLight.this,Kitchen.class));
        });
    }
