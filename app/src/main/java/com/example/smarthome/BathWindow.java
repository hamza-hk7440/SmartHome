...
public class BathWindow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bath_window);
        ...
        windowPassRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    correctCode = snapshot.getValue().toString().trim(); // <-- works for both numbers and strings
                } else {
                    correctCode = "";
                }
            }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (isOpen != null) {
                    ...
                    windowSwitch.setOnCheckedChangeListener((button, checked) -> {
                        ...
                        Toast.makeText(BathWindow.this,
    ...
    private void checkCode(String input) {
        ...
        findViewById(R.id.button7).setOnClickListener(v -> {
            startActivity(new Intent(BathWindow.this, Bath.class));
            finish();
        });
    }
}