...
public class BedroomWindow extends AppCompatActivity {
    // ----- UI -----
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bedroom_window);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (isOpen != null) {
                    ...
                    windowSwitch.setOnCheckedChangeListener((button, checked) -> {
                        ...
                        Toast.makeText(BedroomWindow.this,
    ...
    private void checkCode(String input) {
        ...
        findViewById(R.id.button7).setOnClickListener(v -> {
            startActivity(new Intent(BedroomWindow.this, Bedrooms.class));
            finish();
        });
    }
}
