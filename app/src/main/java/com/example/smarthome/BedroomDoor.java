...
public class BedroomDoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bedroom_door);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (isOpen != null) {
                    ...
                    doorSwitch.setOnCheckedChangeListener((button, checked) -> {
                        ...
                        Toast.makeText(BedroomDoor.this,
    ...
    private void checkCode(String input) {
        ...
        goBack.setOnClickListener(v -> {
            startActivity(new Intent(BedroomDoor.this, Bedrooms.class));
            finish();
        });
    }
}
