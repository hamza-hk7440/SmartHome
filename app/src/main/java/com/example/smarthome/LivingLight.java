...
public class LivingLight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_living_light);
        ...
        lightRef= FirebaseDatabase.getInstance().getReference("users").child(uid).child("livingRoomStatus").child("light");
        ...
        goBack.setOnClickListener(v -> {
            startActivity(new Intent(LivingLight.this,LivingRoom.class));
        });
    }
