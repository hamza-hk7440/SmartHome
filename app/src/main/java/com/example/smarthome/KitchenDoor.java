...
public class KitchenDoor extends AppCompatActivity {
    // ----- UI -----
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kitchen_door);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (isOpen != null) {
                    ...
                    doorSwitch.setOnCheckedChangeListener((button, checked) -> {
                        ...
                        Toast.makeText(KitchenDoor.this,
    ...
    private void checkCode(String input) {
        ...
        goBack.setOnClickListener(v -> {
            startActivity(new Intent(KitchenDoor.this, Kitchen.class));
            finish();
        });
    }
}
