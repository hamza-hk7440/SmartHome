...
public class LivingAir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_living_air);
        ...
        airDegRef = FirebaseDatabase.getInstance().getReference("users")
                .child(uid).child("livingRoomStatus").child("airDeg");

        airCondRef = FirebaseDatabase.getInstance().getReference("users")
                .child(uid).child("livingRoomStatus").child("air");
        ...
        goBack.setOnClickListener(v -> {
            startActivity(new Intent(LivingAir.this, LivingRoom.class));
            finish();
        });
    }
}