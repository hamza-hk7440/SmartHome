...
public class LivingDoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_living_door);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (isOpen != null) {
                    ...
                    doorSwitch.setOnCheckedChangeListener((button, checked) -> {
                        ...
                        Toast.makeText(LivingDoor.this,
    ...
    private void checkCode(String input) {
        ...
        goBack.setOnClickListener(v -> {
            startActivity(new Intent(LivingDoor.this, LivingRoom.class));
            finish();
        });
    }
}