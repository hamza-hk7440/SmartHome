...
public class BathLight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bath_light);
        ...
        lightRef= FirebaseDatabase.getInstance().getReference("users").child(uid).child("bathStatus").child("light");
        ...
        lightRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(isOn!=null){
                    ...
                    lightSwitch.setOnCheckedChangeListener((buttonView, checked) -> {
                        lightRef.setValue(checked);
                    });
        ...
        goBack.setOnClickListener(v -> {
            startActivity(new Intent(BathLight.this,Bath.class));
        });
    }
